...
1.upto(100) do |n|
  Entleiher.create(:anschrift => Faker::Address.street_address, :bearbeiter => Faker::Name.name, :email => Faker::Internet.email, :name => Faker::Name.name)
end
